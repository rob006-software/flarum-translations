...
sides, but do not match between them: **148** are translated differently and **0** are
...
<del>Introduce</del><ins>Introduzca</ins> una o dos frases que describan <del>tu</del><ins>su</ins> <del>foro.</del><ins>comunidad.</ins> Estas aparecerán en el "metatag" y se mostrarán en los buscadores.
...
<del>Introduce</del><ins>Introduzca</ins> el nombre de alguna clase de<del> ícono</del> &lt;a&gt;FontAwesome&lt;/a&gt;, &lt;em&gt;incluyendo&lt;/em&gt; el prefijo<del> (e.g.</del> &lt;code&gt;fas<del> fa-flag&lt;/code&gt; o &lt;code&gt;fa-solid</del> <del>fa-flag&lt;/code&gt;).</del><ins>fa-&lt;/code&gt;.</ins>
